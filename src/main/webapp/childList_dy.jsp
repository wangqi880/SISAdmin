...
<div class="main">
    ...
    <div class="listTable" style="text-align: center;width: 100%;margin-top: 300px">
        <table class="table table-hover" style="width: 70%;margin: 0 auto;text-align: center" >
           ...
           <tr class="userInfo" style="cursor: pointer">
               ...
               <td><a href="print.jsp?studentId=<%=info.getStudentId() %>&studentName=<%=info.getStuName() %>"><%=info.getStuName() %></a></td>
    ...
    <a href="<%=basePath %>phoneCode_dy.jsp" class="stepBtu"><img src="<%=path %>/static/img/lastStep.png"></a>
